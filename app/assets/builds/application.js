...
%o`, message, error2, detail);
  ...
  __publicField(password_controller_default, "targets", ["progressBar", "message", "input", "container"]);

  // node_modules/stimulus-password-visibility/dist/stimulus-password-visibility.mjs
  var s = class extends Controller {
    ...
    toggle(t) {
      t.preventDefault(), this.inputTarget.type = this.hidden ? "text" : "password", this.hidden = !this.hidden, this.iconTargets.forEach((e) => e.classList.toggle(this.class));
    }
  };
  s.targets = ["input", "icon"];
  s.classes = ["hidden"];

  // app/javascript/controllers/index.js
  application.register("hello", hello_controller_default);
  application.register("password", password_controller_default);
  application.register("password-visibility", s);
})();
